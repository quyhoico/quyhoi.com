	...
	jQuery('.load_more_works').on( 'click', function(){
		...
		if (now_load > 0) {			
			...
			for (var i = i_start-1; i < i_start+now_load-1; i++) {
				loaded_object = loaded_object + '<div data-category="'+ addon_options.items[i].category +' " class="blogpost_preview_fw element '+ addon_options.items[i].category +'"><div class="fw_preview_wrapper"><div class="gallery_item_wrapper"><a href="'+ addon_options.items[i].url +'" ><img src="'+ addon_options.items[i].src +'" alt="" class="fw_featured_image" width="540"><div class="gallery_fadder"></div></a></div><div class="grid-port-cont"><h6><a href="'+ addon_options.items[i].url +'">'+ addon_options.items[i].title +'</a></h6></div></div></div>';
			}
